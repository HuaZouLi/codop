...
describe("useFileLinkOpener", () => {
  ...
  it("maps /workspace root-relative paths to the active workspace path", async () => {
    const workspacePath = "/Users/sotiriskaniras/Documents/Development/Forks/codop";
    ...
    expect(openWorkspaceInMock).toHaveBeenCalledWith(
      "/Users/sotiriskaniras/Documents/Development/Forks/codop/src/features/messages/components/Markdown.tsx",
  ...
  it("maps /workspace/<workspace-name>/... paths to the active workspace path", async () => {
    ...
    await act(async () => {
      await result.current.openFileLink(fileTarget("/workspace/codop/LICENSE"));
    });

    expect(openWorkspaceInMock).toHaveBeenCalledWith(
      "/Users/sotiriskaniras/Documents/Development/Forks/codop/LICENSE",
      expect.objectContaining({ appName: "Visual Studio Code", args: [] }),
    );
  });
  ...
  it("maps nested /workspaces/.../<workspace-name>/... paths to the active workspace path", async () => {
    ...
    await act(async () => {
      await result.current.openFileLink(fileTarget("/workspaces/team/codop/src"));
    });

    expect(openWorkspaceInMock).toHaveBeenCalledWith(
      "/Users/sotiriskaniras/Documents/Development/Forks/codop/src",
      expect.objectContaining({ appName: "Visual Studio Code", args: [] }),
    );
  });
  ...
  it("parses #L line anchors before opening the editor", async () => {
    ...
    expect(openWorkspaceInMock).toHaveBeenCalledWith(
      "/Users/sotiriskaniras/Documents/Development/Forks/codop/src/App.tsx",
      expect.objectContaining({
        appName: "Visual Studio Code",
        args: [],
        line: 33,
